;(function (window) {
  ...
  let texts = ['2017年6月29日', '男孩加了女孩微信', '开始了尬聊', '2017年7月3日', '雨后第一次约会', '昏暗的灯光中', '女孩娇小活泼', '男孩手足无措', '就这么走着聊着', '女孩到家了', '为啥要走这么快', '男孩突然觉得','开心中又有不舍', '可能从那一刻', '在他的眼中', '女孩是这么得好', '好想下一次压马路', '好想一直走下去', '开始期待着', '下一次约会', '期待着', '下一条微信', '想知道', '她有没有睡好', '想知道', '她在干嘛', '男孩问自己', '你是认真的吗','YES','因为心不会说谎','每个晚上都在想你','期待着每一天和你', '同在这一片星空下','宝宝','期待我像这星空','永远能陪着你']
