;(function (window) {
  ...
  let texts = ['2017年6月29日午', '有两个逗比加了微信', '开始了尬聊', '2017年7月3日晚', '差点因为下雨错过了第一次约会', '互相在昏暗的灯光中打量对方', '女孩娇小活泼', '男孩手足无措', '男孩问自己这么紧张干嘛', '两个人聊着天绕着小区走了一圈', '女孩到家了', '男孩突然觉得为啥要走这么快', '开心中又有点不舍', '可能从那一刻', '在他的眼中', '女孩是这么得好', '好想下一次压马路', '好想和她一直这么走下去', '期待着下一次约会', '期待着下一条微信', '想知道她有没有睡好', '想知道她在干嘛', '男孩问自己是认真的吗','YES','因为这种感觉从未有过','每个晚上都在想着接下去的日子','期待着每一天在和你同在这一片星空下','宝宝','期待我能像这片星空','永远能陪着你']
